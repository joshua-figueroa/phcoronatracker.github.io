...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            update('critical', data.critical);
            update('total-critical', data.critical);
